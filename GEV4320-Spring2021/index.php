...
<html>
	...
	<body>
		...
		<header>
			<!-- <div class="row"> -->
				<div class="columns medium-7">
					...
					<p class="intro">In Spring of 2021, students in Professor Jennifer Santoro's GEV 4320/8320: GIS for Conservation Management course at Villanova University used Esri Story Maps to tell compelling ecological conservation stories for their final class projects.</p>
				</div>
		...
		<ul id="sponsors">
				...
				<!--<li class="logo"><p class="logo">Falvey Memorial Library</p></li>-->
				<li class="logo">
